...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PushDistanceStart_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_PushDistanceStart;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PushDistance_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_PushDistance;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistanceStart_MetaData[] = {
		{ "Category", "Component Settings" },
		{ "ModuleRelativePath", "Dustpan.h" },
		{ "ToolTip", "Distance when Dustpan can start push" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistanceStart = { UE4CodeGen_Private::EPropertyClass::Float, "PushDistanceStart", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000005, 1, nullptr, STRUCT_OFFSET(UDustpan, PushDistanceStart), METADATA_PARAMS(Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistanceStart_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistanceStart_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistance_MetaData[] = {
		{ "Category", "Component Settings" },
		{ "ModuleRelativePath", "Dustpan.h" },
		{ "ToolTip", "Distance enemy is pushed away" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistance = { UE4CodeGen_Private::EPropertyClass::Float, "PushDistance", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000005, 1, nullptr, STRUCT_OFFSET(UDustpan, PushDistance), METADATA_PARAMS(Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistance_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDustpan_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistanceStart,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDustpan_Statics::NewProp_PushDistance,
	...
	IMPLEMENT_CLASS(UDustpan, 1168308341);
