...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULifeComponent_Statics::NewProp_HitPoints_MetaData[] = {
		{ "Category", "Component settings" },
		{ "ModuleRelativePath", "LifeComponent.h" },
		{ "ToolTip", "Current hit points" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULifeComponent_Statics::NewProp_HitPoints = { UE4CodeGen_Private::EPropertyClass::Float, "HitPoints", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000005, 1, nullptr, STRUCT_OFFSET(ULifeComponent, HitPoints), METADATA_PARAMS(Z_Construct_UClass_ULifeComponent_Statics::NewProp_HitPoints_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULifeComponent_Statics::NewProp_HitPoints_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULifeComponent_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULifeComponent_Statics::NewProp_HitPoints,
	};
	...
	IMPLEMENT_CLASS(ULifeComponent, 3956258321);
