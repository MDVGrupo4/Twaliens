...
// Cross Module References
	...
	TWALIENS_API UFunction* Z_Construct_UFunction_ATwalien_SetIsDead();
	TWALIENS_API UFunction* Z_Construct_UFunction_ATwalien_SetIsSpawnable();
...
// End Cross Module References
	...
	void ATwalien::StaticRegisterNativesATwalien()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetIsDead", &ATwalien::execSetIsDead },
			{ "SetIsSpawnable", &ATwalien::execSetIsSpawnable },
		};
	...
	struct Z_Construct_UFunction_ATwalien_SetIsDead_Statics
	{
		struct Twalien_eventSetIsDead_Parms
		{
			bool Dead;
		};
	...
	void Z_Construct_UFunction_ATwalien_SetIsDead_Statics::NewProp_Dead_SetBit(void* Obj)
	{
		((Twalien_eventSetIsDead_Parms*)Obj)->Dead = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ATwalien_SetIsDead_Statics::NewProp_Dead = { UE4CodeGen_Private::EPropertyClass::Bool, "Dead", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(Twalien_eventSetIsDead_Parms), &Z_Construct_UFunction_ATwalien_SetIsDead_Statics::NewProp_Dead_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATwalien_SetIsDead_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATwalien_SetIsDead_Statics::NewProp_Dead,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATwalien_SetIsDead_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Twalien.h" },
		{ "ToolTip", "Set the dead state of the player" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ATwalien_SetIsDead_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATwalien, "SetIsDead", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00020401, sizeof(Twalien_eventSetIsDead_Parms), Z_Construct_UFunction_ATwalien_SetIsDead_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ATwalien_SetIsDead_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATwalien_SetIsDead_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ATwalien_SetIsDead_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATwalien_SetIsDead()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ATwalien_SetIsDead_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics
	{
		struct Twalien_eventSetIsSpawnable_Parms
		{
			bool Spawn;
		};
		static void NewProp_Spawn_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_Spawn;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	void Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::NewProp_Spawn_SetBit(void* Obj)
	{
		((Twalien_eventSetIsSpawnable_Parms*)Obj)->Spawn = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::NewProp_Spawn = { UE4CodeGen_Private::EPropertyClass::Bool, "Spawn", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(Twalien_eventSetIsSpawnable_Parms), &Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::NewProp_Spawn_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::NewProp_Spawn,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Twalien.h" },
		{ "ToolTip", "Set the spawn state of the player" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATwalien, "SetIsSpawnable", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00020401, sizeof(Twalien_eventSetIsSpawnable_Parms), Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATwalien_SetIsSpawnable()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ATwalien_SetIsSpawnable_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATwalien_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ATwalien_SetIsDead, "SetIsDead" }, // 614719247
		{ &Z_Construct_UFunction_ATwalien_SetIsSpawnable, "SetIsSpawnable" }, // 887297619
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATwalien_Statics::NewProp_WeaponType_MetaData[] = {
		{ "Category", "Player Settings" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Twalien.h" },
		{ "ToolTip", "Validate if payer has died" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATwalien_Statics::NewProp_WeaponType = { UE4CodeGen_Private::EPropertyClass::Object, "WeaponType", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00200800000a000d, 1, nullptr, STRUCT_OFFSET(ATwalien, WeaponType), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ATwalien_Statics::NewProp_WeaponType_MetaData, ARRAY_COUNT(Z_Construct_UClass_ATwalien_Statics::NewProp_WeaponType_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATwalien_Statics::NewProp_IsDead_MetaData[] = {
		{ "Category", "Player Settings" },
		{ "ModuleRelativePath", "Twalien.h" },
		{ "ToolTip", "Validate if payer has died" },
	};
#endif
	void Z_Construct_UClass_ATwalien_Statics::NewProp_IsDead_SetBit(void* Obj)
	{
		((ATwalien*)Obj)->IsDead = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ATwalien_Statics::NewProp_IsDead = { UE4CodeGen_Private::EPropertyClass::Bool, "IsDead", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(ATwalien), &Z_Construct_UClass_ATwalien_Statics::NewProp_IsDead_SetBit, METADATA_PARAMS(Z_Construct_UClass_ATwalien_Statics::NewProp_IsDead_MetaData, ARRAY_COUNT(Z_Construct_UClass_ATwalien_Statics::NewProp_IsDead_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATwalien_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATwalien_Statics::NewProp_WeaponType,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATwalien_Statics::NewProp_IsDead,
	...
	IMPLEMENT_CLASS(ATwalien, 3605851198);
