...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCheckEnemyAtMeleeRange_Statics::NewProp_OverlapDistance_MetaData[] = {
		{ "Category", "Decorator Property" },
		{ "ModuleRelativePath", "CheckEnemyAtMeleeRange.h" },
	};
#endif
	void Z_Construct_UClass_UCheckEnemyAtMeleeRange_Statics::NewProp_OverlapDistance_SetBit(void* Obj)
	{
		((UCheckEnemyAtMeleeRange*)Obj)->OverlapDistance = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCheckEnemyAtMeleeRange_Statics::NewProp_OverlapDistance = { UE4CodeGen_Private::EPropertyClass::Bool, "OverlapDistance", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UCheckEnemyAtMeleeRange), &Z_Construct_UClass_UCheckEnemyAtMeleeRange_Statics::NewProp_OverlapDistance_SetBit, METADATA_PARAMS(Z_Construct_UClass_UCheckEnemyAtMeleeRange_Statics::NewProp_OverlapDistance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCheckEnemyAtMeleeRange_Statics::NewProp_OverlapDistance_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCheckEnemyAtMeleeRange_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCheckEnemyAtMeleeRange_Statics::NewProp_OverlapDistance,
	...
	IMPLEMENT_CLASS(UCheckEnemyAtMeleeRange, 3644521457);
