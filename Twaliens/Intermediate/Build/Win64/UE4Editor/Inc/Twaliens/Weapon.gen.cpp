...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_Ammunition;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWeapon_Statics::NewProp_Ammunition_MetaData[] = {
		{ "Category", "Projectile" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Amunnition" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UWeapon_Statics::NewProp_Ammunition = { UE4CodeGen_Private::EPropertyClass::Int, "Ammunition", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000001, 1, nullptr, STRUCT_OFFSET(UWeapon, Ammunition), METADATA_PARAMS(Z_Construct_UClass_UWeapon_Statics::NewProp_Ammunition_MetaData, ARRAY_COUNT(Z_Construct_UClass_UWeapon_Statics::NewProp_Ammunition_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UWeapon_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeapon_Statics::NewProp_Ammunition,
	...
	IMPLEMENT_CLASS(UWeapon, 1100016037);
